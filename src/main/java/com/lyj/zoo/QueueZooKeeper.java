...
/**
 * 1. 创建一个父目录 /queue，每个成员都监控(Watch)标志位目录/queue/start 是否存在，
 * 2. 然后每个成员都加入这个队列，加入队列的方式就是创建 /queue/x(i)的临时目录节点 
 * 3. 然后每个成员获取 /queue 目录的所有目录节点，也就是x(i)。
 * 4. 判断 i的值是否已经是成员的个数 
 * 		4.1 如果小于成员个数等待 /queue/start 的出现 
 * 		4.2如果已经相等就创建/queue/start。
 * 
 * @author Jack
 *
 */
public class QueueZooKeeper {
	...
	public static void doOne() throws Exception {
		String host1 = "192.168.72.134:2181";
	...
	public static void doAction(int client) throws Exception {
		String host1 = "192.168.72.134:2181";
		String host2 = "192.168.72.134:2182";
		String host3 = "192.168.72.134:2183";
